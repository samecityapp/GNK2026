...
-- Migration to add Sapanca Transport Article
-- Conformed to migration script Case B (10 values)
...
INSERT INTO public.articles (
    ...
    'İstanbul’dan Sapanca’ya Arabasız Ulaşım Rehberi: YHT, Otobüs ve VIP Seçenekler',
    'sapanca-arabasiz-ulasim-rehberi-yht-otobus',
    '<h1>İstanbul’dan Sapanca’ya Arabasız Ulaşım Rehberi: YHT, Otobüs ve VIP Seçenekler</h1>
...
<div class="bg-green-50 p-6 rounded-lg text-center mt-8">
    ...
    '/images/blog/sapanca_yht_train_journey.png',
    'Sapanca',
    'İstanbul’dan Sapanca’ya arabasız nasıl gidilir? YHT (Hızlı Tren) durakları, otobüs firmaları ve bungalovlara taksi/transfer tüyoları.',
    true,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP,
    CURRENT_TIMESTAMP
