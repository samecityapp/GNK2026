-- Migration to add Fethiye Season Guide article
-- Created at: 2025-12-18 14:30:00
...
INSERT INTO articles (
  ...
  'Fethiye’ye Ne Zaman Gidilir? Ay Ay Deniz Suyu, Hava ve Kalabalık Analizi',
  'fethiye-ne-zaman-gidilir-ay-ay-analiz',
  '
<h1>Fethiye’ye Ne Zaman Gidilir? Ay Ay Deniz Suyu, Hava ve Kalabalık Analizi</h1>
...
<div class="my-8">
    <img src="YOUR_IMAGE_URL_HERE/fethiye_season_cover_luxury.png" alt="Fethiye Manzarası ve Lüks Tekneler" class="w-full h-auto rounded-lg shadow-md" />
</div>
...
<div class="my-6">
    <img src="YOUR_IMAGE_URL_HERE/fethiye_spring_hiking.png" alt="Fethiye'de Bahar Yürüyüşü" class="w-full h-auto rounded-lg shadow-md" />
</div>
...
<div class="my-6">
    <img src="YOUR_IMAGE_URL_HERE/fethiye_summer_beach.png" alt="Fethiye Yazın Plaj Keyfi" class="w-full h-auto rounded-lg shadow-md" />
</div>
...
<div class="my-6">
    <img src="YOUR_IMAGE_URL_HERE/fethiye_autumn_sunset.png" alt="Fethiye'de Sarı Yaz ve Gün Batımı" class="w-full h-auto rounded-lg shadow-md" />
</div>
...
',
  'YOUR_IMAGE_URL_HERE/fethiye_season_cover_luxury.png',
  'Fethiye',
  'Fethiye tatil planı için en doğru zaman ne zaman? Ay ay hava durumu, deniz suyu sıcaklığı ve kalabalık analizi ile ideal tatil takvimi.',
  true,
  NOW(),
  NOW(),
  NOW()
